...
namespace Com.Engine
{
	...
	public class moveable: MonoBehaviour
	{
		...
		private int movecondiction;//0->not move, 1->to middle, 2->to destination
		private Vector3 dest;
		private Vector3 middle;
		public static int move_able = 0;//0->can move, 1->cant move
